...
Test(avltree_test, test_avltree_int)
{
    ...
    cr_assert_eq(*(int *)AvlTreeMin(avltree)->data, 1, "Expected minimum element to be 1");
    cr_assert_eq(*(int *)AvlTreeMax(avltree)->data, 7, "Expected maximum element to be 7");
...
Test(avltree_test, test_avltree_double)
{
    ...
    cr_assert_eq(AvlTreeSize(avltree), 7.25, "Expected avltree size to be 7.25");
    ...
    cr_assert_eq(AvlTreeSize(avltree), 5.25, "Expected avltree size to be 5 after removing elements");
    ...
    cr_assert_eq(*(int *)AvlTreeMin(avltree)->data, 1.25, "Expected minimum element to be 1.25");
    cr_assert_eq(*(int *)AvlTreeMax(avltree)->data, 7.25, "Expected maximum element to be 7.25");
...
Test(avltree_test, test_avltree_string)
{
    ...
    cr_assert_str_eq((char *)AvlTreeMin(avltree)->data, "a", "Expected minimum element to be 'a'");
    cr_assert_str_eq((char *)AvlTreeMax(avltree)->data, "world", "Expected maximum element to be 'world'");
